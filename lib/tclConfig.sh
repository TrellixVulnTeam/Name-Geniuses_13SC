...
# installed.
TCL_PREFIX='/home/dale/anaconda3/envs/suggester'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/home/dale/anaconda3/envs/suggester'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/home/dale/anaconda3/envs/suggester/lib -ltcl8.5'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/home/dale/anaconda3/envs/suggester/include'
...
TCL_PACKAGE_PATH='/home/dale/anaconda3/envs/suggester/lib '
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/home/dale/anaconda3/envs/suggester/lib -ltclstub8.5'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='-------src-dir-------/tcl8.5.18/unix/libtclstub8.5.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/home/dale/anaconda3/envs/suggester/lib/libtclstub8.5.a'
